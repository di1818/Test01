const docs = [
  { label: "Договор оферта", href: "/docs/offer.html" },
  { label: "Политика обработки данных", href: "/docs/privacy.html" },
  { label: "Согласие на обработку данных", href: "/docs/personal-consent.html" },
  { label: "Согласие на рекламу", href: "/docs/marketing-consent.html" },
];
